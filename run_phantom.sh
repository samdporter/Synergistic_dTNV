...
alphas=(8192 2048 512 128)
betas=(8192 2048 512 128)
...
for alpha in "${alphas[@]}"; do
    for beta in "${betas[@]}"; do
        ...
        output_dir="${BASE_OUTPUT}/MIC25/alpha_${alpha}_beta_${beta}_${timestamp}"
        ...
        python3 "${SCRIPT_PATH}" --alpha "${alpha}" --beta "${beta}" --output_path "${output_dir}" --tail_singular_values 2 --num_epochs 15 --use_kappa
